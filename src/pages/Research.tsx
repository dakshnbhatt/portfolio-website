...
This project has shown me how much subtlety there is in astronomical observation, and how seemingly small factors like dust can reshape our big-picture conclusions. It's made me think more deeply about what we see, and what we don't, when we look out into the universe.`,
    ...
    },
    {
      ...
      abstract: `I conducted astrometric observations of the candidate binary system WDS 20528+6307 (KPP 1724) using data from the Great Basin Observatory, comparing my results with four decades of archival measurements to evaluate its physical association. My analysis—now under peer review at the Journal of Double Star Observations—revealed consistent relative motion between the components, suggesting a likely common proper motion pair. Motivated by this work, I later developed a Python-based pipeline that integrates Gaia DR3 data to statistically assess gravitational binding between stellar pairs, forming the foundation of a second manuscript currently in preparation.`,
      fullContent: `Like a pirate, I’ve always believed that science—much like the open sea—should be open to everyone. You don’t need a “fancy ship” to sail; you just need curiosity and the will to explore. That shared belief with Jerry Hilburn, Director of the Great Basin Observatory (GBO), shaped the spirit of my first independent research project in observational astrophysics.

I joined the GBO with a deceptively simple question: How can we truly tell if two stars are bound by gravity, or merely share a line of sight? Traditional catalogs, such as the Washington Double Star Catalog (WDSC), often classify pairs by apparent proximity, but closeness alone doesn’t guarantee a physical relationship. I wanted to go beyond appearance—to probe the dynamics beneath it.

Using the WDSC and Gaia DR3 databases, I identified a list of promising candidate systems and selected WDS 20528+6307 (KPP 1724) for detailed study due to its optimal brightness and observability from GBO. Over several weeks, I obtained ten high-quality images of the target and performed precise astrometric reductions in AstroImageJ, measuring separations, position angles, and uncertainties for each frame.

To place these measurements in context, I compared them with forty years of archival data from the U.S. Naval Observatory. The results were striking: the stars’ separation had changed by only about 1.1 arcseconds over four decades, implying extremely slow relative motion. Combined with Gaia’s near-identical parallax and proper motion values, the evidence pointed strongly toward a common proper motion pair—or even a gravitationally bound binary. These findings formed the basis of my first research paper, now under review in the Journal of Double Star Observations.

But the project didn’t end there. The experience made me question the broader reliability of “binary” classifications that ignore the physics of gravitational binding. Determined to improve on this, I began developing a Python-based analysis pipeline that uses Gaia DR3 astrometric and photometric data to compute the probability that two stars are truly gravitationally bound.

The program reconstructs each system’s 3D spatial configuration, applies energy-based criteria from classical mechanics, and uses Monte Carlo uncertainty propagation to estimate confidence levels for gravitational association. It also derives stellar parameters such as mass and luminosity by calibrating photometric data to solar standards—producing a physically self-consistent model of each system’s dynamical stability.
